...
class ProductPage extends Component
{
    ...
    {
        // !is_null($this->catSelected) ? dd($this->catSelected) : '';
        ...
        return view('livewire.product-page', ['categories' => $categories, 'products' => $products, 'active2' => $active2->id, 'allproducts' => $allproducts]);
    }
}
