...
<footer
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl mx-auto">
                ...
                <div class="flex space-x-10 justify-center items-center mb-10">
                    <a href="{{ $settings->instagram }}" class="block  text-gray-300 transition-all duration-500 hover:text-gray-600/90">
    ...
    <a href="https://api.whatsapp.com/send?phone={{ $settings->whatsapp }}&text=Olá, gostaria de mais informações sobre os produtos e serviços." target="_blank" rel="noreferrer noopener" class="fixed bottom-4 right-4 z-50 inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#25d366]">
