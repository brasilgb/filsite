<div class="bg-[#06364D]">
    <div class="container  m-auto md:flex hidden items-center" :class="{ 'h-10': !scrolledFromTop, 'h-0': scrolledFromTop }">
        <div class="flex items-center justify-around gap-7 text-xs w-full text-gray-50 ">
            ...
            <div>
                <a href="{{ $settings->instagram }}" target="_blank" rel="noopener noreferrer" title="Acesse nosso Instagram" class="block  text-gray-300 transition-all duration-500 hover:text-gray-600/90">
