    ...
    <div class="container h-10 m-auto md:flex hidden items-center"
        ...
        <div class="flex items-center justify-around gap-7 text-xs w-full text-gray-50 ">
            <div class="flex items-center gap-2">
                ...
                {{ $settings ? $settings->street : '' }}, {{ $settings ? $settings->number : '' }} - {{ $settings ? $settings->neighborhood : '' }} - {{ $settings ? $settings->city : '' }}
            </div>
            <div class="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <div>
                <a href="{{ $settings ? $settings->instagram : '' }}" target="_blank" rel="noopener noreferrer"
                ...
                <div class="md:hidden">
                    <div class="flex flex-col items-start justify-around gap-5 text-sm w-full text-gray-50 pl-2">
                        <div class="flex items-center gap-2">
                            ...
                            {{ $settings ? $settings->street : '' }}, {{ $settings ? $settings->number : '' }} - {{ $settings ? $settings->neighborhood : '' }} -
