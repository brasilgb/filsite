...
<body x-data="{ navOpen: false, scrolledFromTop: false }" x-init="window.pageYOffset >= 50 ? scrolledFromTop = true : scrolledFromTop = false"
    ...
    <div class="min-h-screen flex flex-col antialiased font-roboto">
        ...
        <a href="https://api.whatsapp.com/send?phone=5551995179173&text=Olá, gostaria de mais informações sobre produtos e serviços." target="_blank" rel="noreferrer noopener" class="fixed bottom-4 right-4 z-50 inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#25d366]">
